...
def test_thompson_sampling_gp_iteration():
    ...
    with pytest.raises(AssertionError) as error:
        package_target.thompson_sampling_gp_iteration(
            arr_range,
            X,
            Y,
    ...
    next_point = package_target.thompson_sampling_gp_iteration(
        arr_range,
        X,
        Y,
        normalize_Y=normalize_Y,
...
def test_thompson_sampling_gp():
    ...
    with pytest.raises(AssertionError) as error:
        package_target.thompson_sampling_gp(
            arr_range,
            fun_objective,
            num_init,
            num_iter,
    ...
    X_, Y_ = package_target.thompson_sampling_gp(
        arr_range,
        fun_objective,
        num_init,
        num_iter,
